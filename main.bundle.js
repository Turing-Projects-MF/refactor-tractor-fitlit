...
/* harmony import */ var _Fitness__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Fitness */ "./src/Fitness.js");


class Activity extends _Fitness__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class Hydration extends _Fitness__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class Sleep extends _Fitness__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class UserRepo extends _Fitness__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(users) {
    super(users);
    this.users = users;
  }
...
let domDisplay = {
  ...
  displaySidebarDetails(user) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#sidebarName').text(user.name);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#headerText').text(`${user.getFirstName()}'s Activity Tracker`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#stepGoalCard').text(`Your daily step goal is ${user.dailyStepGoal}.`);
  },

  displayUserSidebar(user, userStorage) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userAddress').text(user.address);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userEmail').text(user.email);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userStridelength').text(`Your stridelength is ${user.strideLength} meters.`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#friendList').prepend(domDisplay.makeFriendHTML(user, userStorage));
  },
  ...
  addHydrationInfo(id, hydrationInfo, dateString, userStorage, laterDateString) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#hydrationToday').prepend(`<p>You drank</p><p><span class="number">${hydrationInfo.calculateDailyOunces(id, dateString)}</span></p><p>oz water today.</p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#hydrationAverage').prepend(`<p>Your average water intake is</p><p><span class="number">${hydrationInfo.calculateAverageOunces(id, hydrationInfo.hydrationData)}</span></p> <p>oz per day.</p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#hydrationThisWeek').prepend(domDisplay.makeHydrationHTML(id, hydrationInfo, userStorage, hydrationInfo.calculateFirstWeekOunces(userStorage, id)));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#hydrationEarlierWeek').prepend(domDisplay.makeHydrationHTML(id, hydrationInfo, userStorage, hydrationInfo.calculateRandomWeekOunces(laterDateString, id, userStorage)));
  },
  ...
  addSleepInfo(id, sleepInfo, dateString, userStorage, laterDateString) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#sleepToday').prepend(`<p>You slept</p> <p><span class="number">${sleepInfo.calculateDailySleep(id, dateString)}</span></p> <p>hours today.</p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#sleepQualityToday').prepend(`<p>Your sleep quality was</p> <p><span class="number">${sleepInfo.calculateDailySleepQuality(id, dateString)}</span></p><p>out of 5.</p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#avUserSleepQuality').prepend(`<p>The average user's sleep quality is</p> <p><span class="number">${Math.round(sleepInfo.calculateAllUserSleepQuality() * 100) / 100}</span></p><p>out of 5.</p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#sleepThisWeek').prepend(domDisplay.makeSleepHTML(id, sleepInfo, userStorage, sleepInfo.calculateWeekSleep(dateString, id, userStorage)));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#sleepEarlierWeek').prepend(domDisplay.makeSleepHTML(id, sleepInfo, userStorage, sleepInfo.calculateWeekSleep(laterDateString, id, userStorage)));
  },
  ...
  addWeeklyStepInfo(id, activityInfo, dateString, userStorage, laterDateString, user, winnerId) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userStepsThisWeek').prepend(domDisplay.makeStepsHTML(id, activityInfo, userStorage, activityInfo.userDataForWeek(id, dateString, userStorage, 'numSteps')));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userStairsThisWeek').prepend(domDisplay.makeStairsHTML(id, activityInfo, userStorage, activityInfo.userDataForWeek(id, dateString, userStorage, 'flightsOfStairs')));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userMinutesThisWeek').prepend(domDisplay.makeMinutesHTML(id, activityInfo, userStorage, activityInfo.userDataForWeek(id, dateString, userStorage, 'minutesActive')));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#bestUserSteps').prepend(domDisplay.makeStepsHTML(user, activityInfo, userStorage, activityInfo.userDataForWeek(winnerId, dateString, userStorage, 'numSteps')));
  },

  addUserTodayStepDetails(id, activityInfo, dateString, userStorage) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userStairsToday').prepend(`<p>Stair Count:</p><p>You</><p><span class="number">${activityInfo.userDataForToday(id, dateString, userStorage, 'flightsOfStairs')}</span></p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userStepsToday').prepend(`<p>Step Count:</p><p>You</p><p><span class="number">${activityInfo.userDataForToday(id, dateString, userStorage, 'numSteps')}</span></p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userMinutesToday').prepend(`<p>Active Minutes:</p><p>You</p><p><span class="number">${activityInfo.userDataForToday(id, dateString, userStorage, 'minutesActive')}</span></p>`);
  },

  addUserAvgStepDetails(id, activityInfo, dateString, userStorage) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#avgStairsToday').prepend(`<p>Stair Count: </p><p>All Users</p><p><span class="number">${activityInfo.getAllUserAverageForDay(dateString, userStorage, 'flightsOfStairs')}</span></p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#avgStepsToday').prepend(`<p>Step Count:</p><p>All Users</p><p><span class="number">${activityInfo.getAllUserAverageForDay(dateString, userStorage, 'numSteps')}</span></p>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#avgMinutesToday').prepend(`<p>Active Minutes:</p><p>All Users</p><p><span class="number">${activityInfo.getAllUserAverageForDay(dateString, userStorage, 'minutesActive')}</span></p>`);
  },
  ...
  addFriendGameInfo(id, activityInfo, userStorage, dateString, laterDateString, user) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#friendChallengeListToday').prepend(domDisplay.makeFriendChallengeHTML(activityInfo.showChallengeListAndWinner(user, dateString, userStorage)));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#streakList').prepend(domDisplay.makeStepStreakHTML(activityInfo.getStreak(userStorage, id, 'numSteps')));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#streakListMinutes').prepend(domDisplay.makeStepStreakHTML(activityInfo.getStreak(userStorage, id, 'minutesActive')));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#friendChallengeListHistory').prepend(domDisplay.makeFriendChallengeHTML(activityInfo.showChallengeListAndWinner(user, dateString, userStorage)));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#bigWinner').prepend(`THIS WEEK'S WINNER! ${activityInfo.showcaseWinner(user, dateString, userStorage)} steps`);
  },
...
/* harmony import */ var _api_request__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./api-request */ "./src/api-request.js");
...
let sleepRepo;
let activityRepo;
let userActivityInput = jquery__WEBPACK_IMPORTED_MODULE_9___default()('#user__activity__input');
let userHydrationInput = jquery__WEBPACK_IMPORTED_MODULE_9___default()('#user__hydration__input');
let userSleepInput = jquery__WEBPACK_IMPORTED_MODULE_9___default()('#user__sleep__input');
let currentUser;

const recievedUserData = _api_request__WEBPACK_IMPORTED_MODULE_11__["default"].getUserData();
const recievedSleepData = _api_request__WEBPACK_IMPORTED_MODULE_11__["default"].getSleepData();
const recievedActivityData = _api_request__WEBPACK_IMPORTED_MODULE_11__["default"].getActivityData();
const recievedHydrationData = _api_request__WEBPACK_IMPORTED_MODULE_11__["default"].getHydrationData();
...
jquery__WEBPACK_IMPORTED_MODULE_9___default()("#user__activities").on("change", displayActivityInput);
jquery__WEBPACK_IMPORTED_MODULE_9___default()('.user__input__button').on("click", updateUserInformation);
...
function startApp() {
  ...
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].displayRandomUserHistory(randomHistory);
...
function updateUserInformation() {
  let value = jquery__WEBPACK_IMPORTED_MODULE_9___default()('#user__activities').val();
  switch (value) {
  case 'Hydration':
...
function recordUserActityData() {
  fetch('https://fe-apps.herokuapp.com/api/v1/fitlit/1908/activity/activityData', {
    ...
    body: JSON.stringify({
      ...
      "date": getTodaysDate(),
      "numSteps": jquery__WEBPACK_IMPORTED_MODULE_9___default()('#number__of__steps').val(),
      "minutesActive": jquery__WEBPACK_IMPORTED_MODULE_9___default()('#active__minutes').val(),
      "flightsOfStairs": jquery__WEBPACK_IMPORTED_MODULE_9___default()('#flights_stairs').val()
    }),
  })
    .then(response => response.json())
    .catch(error => console.log(error))
...
function recordUserSleepData() {
  fetch('https://fe-apps.herokuapp.com/api/v1/fitlit/1908/sleep/sleepData', {
    ...
    body: JSON.stringify({
      "userID": currentUser.id,
      "date": getTodaysDate(),
      "hoursSlept": jquery__WEBPACK_IMPORTED_MODULE_9___default()('#hours__slept').val(),
      "sleepQuality": jquery__WEBPACK_IMPORTED_MODULE_9___default()('#sleep__quality').val()
    }),
  })
    .then(response => response.json())
    .catch(error => console.log(error))
...
function recordUserHydrationData() {
  fetch('https://fe-apps.herokuapp.com/api/v1/fitlit/1908/hydration/hydrationData', {
    ...
    body: JSON.stringify({
      "userID": currentUser.id,
      "date": getTodaysDate(),
      "numOunces": jquery__WEBPACK_IMPORTED_MODULE_9___default()('#total__water').val()
    }),
  })
    .then(response => response.json())
    .catch(error => console.log(error))
...
function generateInitialInfo(userNowId, activityRepo, userRepo, today, randomHistory, userNow) {
  ...
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].addFriendGameInfo(userNowId, activityRepo, userRepo, today, randomHistory, userNow);
}

function generateActivityInfo(userNowId, activityRepo, today, userRepo, randomHistory, userNow) {
  let winnerNow = makeWinnerID(activityRepo, userNow, today, userRepo);
  addActivityInfo(userNowId, activityRepo, today, userRepo, randomHistory, userNow, winnerNow);
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].addHydrationInfo(userNowId, hydrationRepo, today, userRepo, randomHistory);
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].addSleepInfo(userNowId, sleepRepo, today, userRepo, randomHistory);
}
...
function createUserData() {
  hydrationRepo = new _Hydration__WEBPACK_IMPORTED_MODULE_6__["default"](hydrationData);
  sleepRepo = new _Sleep__WEBPACK_IMPORTED_MODULE_7__["default"](sleepData);
  activityRepo = new _Activity__WEBPACK_IMPORTED_MODULE_5__["default"](activityData);
}

function makeUsers(array) {
  userData.forEach(dataItem => {
    let user = new _User__WEBPACK_IMPORTED_MODULE_4__["default"](dataItem);
    array.push(user);
  });
}
...
function addInfoToSidebar(user, userStorage) {
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].displaySidebarDetails(user);
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].displayUserSidebar(user, userStorage);
}
...
function addActivityInfo(id, activityInfo, dateString, userStorage, laterDateString, user, winnerId) {
  ...
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].addWeeklyStepInfo(id, activityInfo, dateString, userStorage, laterDateString, user, winnerId);
}

function addTodayStepInfo(id, activityInfo, dateString, userStorage, laterDateString, user, winnerId) {
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].addUserTodayStepDetails(id, activityInfo, dateString, userStorage, laterDateString, user, winnerId);
  _dom_display__WEBPACK_IMPORTED_MODULE_10__["default"].addUserAvgStepDetails(id, activityInfo, dateString, userStorage, laterDateString, user, winnerId);
}
