...
describe('User Repo', function() {
  ...
  it('should return the average of all users step goals', function() {
    console.log(userRepo.calculateAverageStepGoal(userRepo.users));
    expect(userRepo.calculateAverageStepGoal(userRepo.users, 'dailyStepGoal')).to.eql(9500);
  });
  ...
  describe('array changes', function() {
    ...
    it('should get a week of data for all users in data set', function() {
      ...
      expect(weekHydrationData[2].date).to.eql("2019/09/15");
      expect(weekHydrationData[2].userID).to.eql(4);
    });
    it('should get a day of data for all users in data set', function() {
      const dayUserData = userRepo.chooseDayDataForAllUsers(sleepData, '2019/06/15');
    ...
    it('should isolate a user ID and its values of sleep data', function() {
      const getSleepDataByUserId = userRepo.isolateUsernameAndRelevantData(
        ...
        "2019/06/21",
        'sleepQuality',
        userRepo.chooseWeekDataForAllUsers(sleepData, "2019/06/21")
      );

      expect(getSleepDataByUserId).to.eql({
    ...
    it('should isolate a user ID and its values of hydration data', function() {
      const getHydrationDataByUserId = userRepo.isolateUsernameAndRelevantData(
        ...
        "2019/05/09",
        'numOunces',
        userRepo.chooseWeekDataForAllUsers(hydrationData, "2019/05/09")
      );
