...
describe('Friend Activity', function() {
  ...
  it('should get a users friends list', function() {
    expect(activity.getFriendsList(user4, userRepo)).to.eql([
      [
        {
          userID: 1,
          date: '2019/06/15',
  ...
  it('should return a filtered array of users', function() {
    const arrayOfUsers = [
      {
        userID: 1,
        date: '2019/06/02',
    ...
    expect(activity.filterUserSortedArray(arrayOfUsers, 'numSteps')).to.eql([
      {
        userID: 1,
        date: '2019/06/17',
        numSteps: 3579,
